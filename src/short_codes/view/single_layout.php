...
if($banners){ ?>
    ...
    <script type="text/javascript">
        (function($){
            $(document).ready(function(){
                ads_rotator.defaults.opts.container='<?php echo '#zone_'.$ads_zone?>';
                ads_rotator.init();
            });
        })(jQuery);
    ...
    ?>
    <div id="zone_<?php echo $ads_zone?>" class="td-ads-zone-container aside-ads">
        <div class="td-ads-zone-wrapper">
            <?php foreach($banners as $banner){ ?>
            <div id="<?php echo $banner->getId(); ?>" class="td-banner">
                <?php
